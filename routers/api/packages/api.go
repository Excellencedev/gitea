...
func CommonRoutes() *web.Router {
	...
	r.Group("/{username}", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeAlpine), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/arch", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeArch), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/cargo", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeCargo), context.PackageParamsAssignment([]string{"package"}, []string{"version"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/chef", func() {
			r.Group("/api/v1", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeChef), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		...
		}, context.PackageTypeAssignment(packages_model.TypeComposer), context.PackageParamsAssignment([]string{"package"}, []string{"version"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/conan", func() {
			r.Group("/v1", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeConan), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		...
		}, context.PackageTypeAssignment(packages_model.TypeConda), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/cran", func() {
			r.Group("/src", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeCran), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/debian", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeDebian), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/go", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeGo), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		...
		}, context.PackageTypeAssignment(packages_model.TypeGeneric), context.PackageParamsAssignment([]string{"packagename"}, []string{"packageversion"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/helm", func() {
			r.Get("/index.yaml", helm.Index)
			r.Get("/{filename}", helm.DownloadPackageFile)
			r.Post("/api/charts", reqPackageAccess(perm.AccessModeWrite), helm.UploadPackage)
		}, context.PackageTypeAssignment(packages_model.TypeHelm), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/maven", func() {
			r.Put("/*", reqPackageAccess(perm.AccessModeWrite), maven.UploadPackageFile)
			r.Get("/*", maven.DownloadPackageFile)
			r.Head("/*", maven.ProvidePackageFileHeader)
		}, context.PackageTypeAssignment(packages_model.TypeMaven), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/nuget", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeNuGet), context.PackageParamsAssignment([]string{"id"}, []string{"version"}), context.PackageAssignment())
		r.Group("/npm", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypeNpm), context.PackageParamsAssignment([]string{"id"}, []string{"version"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		r.Group("/pub", func() {
		...
		}, context.PackageTypeAssignment(packages_model.TypePub), context.PackageParamsAssignment([]string{"id"}, []string{"version"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))

		r.Group("/pypi", func() {
			r.Post("/", reqPackageAccess(perm.AccessModeWrite), pypi.UploadPackageFile)
			r.Get("/files/{id}/{version}/{filename}", pypi.DownloadPackageFile)
			r.Get("/simple/{id}", pypi.PackageMetadata)
		}, context.PackageTypeAssignment(packages_model.TypePyPI), context.PackageParamsAssignment([]string{"id"}, []string{"version"}), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))

		r.Methods("HEAD,GET", "/rpm.repo", context.PackageTypeAssignment(packages_model.TypeRpm), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead), rpm.GetRepositoryConfig)
		...
		}, context.PackageTypeAssignment(packages_model.TypeRpm), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		...
		}, context.PackageTypeAssignment(packages_model.TypeRubyGems), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
		...
		}, context.PackageTypeAssignment(packages_model.TypeSwift), context.PackageAssignment())
		...
		}, context.PackageTypeAssignment(packages_model.TypeVagrant), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
...
func ContainerRoutes() *web.Router {
	...
	}, container.ReqContainerAccess, context.UserAssignmentWeb(), context.PackageTypeAssignment(packages_model.TypeContainer), context.PackageAssignment(), reqPackageAccess(perm.AccessModeRead))
